...
This app builds the official RemoteTerm `3.13.0` release and adds a small Home Assistant wrapper so you can configure:
...
The web interface host port is changed in the Home Assistant app **Network** settings.
